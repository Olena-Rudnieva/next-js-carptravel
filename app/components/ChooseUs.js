  ...
  return (
    <div class="bg-chooseMobile bg-center bg-cover px-5 py-14 text-white">
      <h2 class="text-[40px] font-thin leading-[56px] tracking-[-1.6px] uppercase mb-6">
        Choose <span class="font-medium">Us</span>
      </h2>
      <div class="flex justify-end ">
        <p class="text-sm font-extralight leading-5 w-[179px] mb-9 ">
          Your chance to join our passionate team in Carpathian tourism. Seeking
          talented professionals to share our common mission.
        </p>
      </div>
      <h3 class="text-3xl font-extralight uppercase text-right mr-9 mb-9">
        Why us ?
      </h3>
      <ul class="w-[181px] text-right">
        <li>
          <h4 class="text-sm font-normal leading-5 mb-2">
            Professional development
          </h4>
          <p class="text-xs font-extralight leading-5 mb-4">
            We offer growth opportunities and a creative environment to nurture
            your talents.
          </p>
        </li>
        <li>
          <h4 class="text-sm font-normal leading-5 mb-2">Teamwork</h4>
          <p class="text-xs font-extralight leading-5 mb-4">
